...
// Create a new Manager object with the name "rwd" and age 22
let manager = new Manager('rwd', 22);

// Print the manager object to the console
console.log(manager); // Manager { name: 'rwd', age: 22, greet: [Function (anonymous)], phone: 1234567890 }
...
console.log(managerGreeting); // Hi rwd
